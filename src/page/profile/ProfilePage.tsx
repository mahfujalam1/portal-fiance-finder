                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg p-6 shadow-sm">
                            <div className="grid grid-cols-3 gap-4">
                                {profileData.images.slice(0, 2).map((img, idx) => (
                                    <div key={idx} className="aspect-square rounded-lg overflow-hidden border-2 border-gray-200">
                                        <img
                                ...
                                <div className="aspect-square rounded-lg border-2 border-dashed border-primary flex items-center justify-center bg-gray-50 cursor-pointer">
