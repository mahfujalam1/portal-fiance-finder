...
interface LifestyleProps extends LifestyleData {
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                                setFormData({
                                    ...formData,
                                    recklessDriving: checked as boolean,
                                })
                            }
                        />
                    </div>
