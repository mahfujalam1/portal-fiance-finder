...
const RefineSearchSidebar = () => {
    ...
    return (
        <div className="w-full fixed max-w-[310px] pe-8 rounded-t-md">
            ...
            <div className="h-[calc(100vh-100px)] overflow-auto no-scrollbar">
                ...
                <div className="bg-white rounded-t-md px-6 py-5 border-b border-gray-200">
                    <h2 className="text-2xl font-bold bg-linear-to-r text-xl to-[#49cce9] from-[#346FB7] bg-clip-text text-transparent text-center">
                        Refine Search
                    </h2>
                </div>
